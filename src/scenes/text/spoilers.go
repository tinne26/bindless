...
var gameTexts = []*lang.Text {
	lang.NewText(
		...
		"\x0BMost people had little reason to complain, but for Mirko... things changed when his brother abandoned the love of his life and his family to go work for Marunka Machart, a member of \x09Leadership\x07.\x03\n" +
		"\x0BIt didn't make any sense. What if the rumors were true? He... had no choice.",
		"\x08Preámbulo\x07\n" +
		"\x0BLa vida en 3589 no trataba mal al ciudadano promedio: el habitaje y la comida estaban garantizados por el estado, el trabajo era voluntario, las calles estaban limpias y las libertades eran mayoritariamente respetadas.\n" +
		...
		"\x0BDesarrolladas durante las Guerras Primales, las \x09unidades MSP\x07 fueron claves en el pasado para acabar con las olas de violencia que plagaban el país. Hoy en día, estos dispositivos magnéticos habían evolucionado para permitir un control sobre los individuos incluso mayor, con ciertas functiones de monitoraje decretadas a permanecer siempre activas.\n" +
		"\x0BLa mayoría de gente no tenía motivo de queja, pero para Mirko... las cosas cambiaron cuando su hermano repentinamente abandonó al amor de su vida y su familia para ir a trabajar para Marunka Machart, una integrante de \x09Cabecera\x07.\x03\n" +
		"\x0BNo tenía ningún sentido. Y si los rumores eran ciertos..? No le quedaba más alternativa.",
		"\x08Preàmbul\x07\n" +
		...
		"\x0BLa majoria de la gent no tenia motius per queixar-se, però per a en Mirko... les coses van canviar quan el seu germà sobtadament va abandonar l'amor de la seva vida i la seva família per anar a treballar per Marunka Machart, una integrant de \x09Capçalera\x07.\x03\n" +
		"\x0BNo tenia cap sentit. I si els rumors eren certs..? No li quedava cap altra alternativa.",
	),
	lang.NewText(
	...
	lang.NewText(
		...
		"\x0B...and thank you for playing!\x04\n" +
		"\x0B\x08>>",
		...
		"\x0B...y gracias a ti por jugar!\x04\n" +
		"\x0B\x08>>",
		"\x08Agraïments\x07\n" +
		...
		"\x0B...i gràcies a tú per jugar!\x04\n" +
		"\x0B\x08>>",
	),	
}
...
var optStoryNow = &ui.HChoice {
	Text: lang.NewText("[ LET'S GET TO IT! ]", "[ VAMOS A ELLO! ]", "[ VINGA, SOM-HI! ]"),
}
